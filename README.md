...
* [`1`, `1-debian-11`, `1.4.1`, `1.4.1-debian-11-r20`, `latest` (1/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-grafana-tempo-query/blob/1.4.1-debian-11-r20/1/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/grafana-tempo-query:latest 'https://github.com/bitnami/bitnami-docker-grafana-tempo-query.git#master:1/debian-11'
```
